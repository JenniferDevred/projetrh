...
<title>Ajouter des absences</title>
...
<h2>Formulaire d'ajout des absences</h2>

<form:form action="saveAbs"  modelAttribute="absence">

<form:label path="idabsence">Idabsence</form:label>
<form:input path="idabsence" /><br>

<form:label path="employeweb.code">Employeweb</form:label>
<form:input path="employeweb.code" /><br>
