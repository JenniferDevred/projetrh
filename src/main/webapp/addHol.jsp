...
<title>Ajouter des congés</title>
...
<h2>Formulaire d'ajout congés</h2>

<form:form action="saveHol"  modelAttribute="conges">

<form:label path="refConges">Ref</form:label>
<form:input path="refConges" /><br>

<form:label path="employeweb">NomEmployé</form:label>
<form:input path="employeweb" /><br>

<form:label path="dateDebut">Départ</form:label>
<form:input path="dateDebut" /><br>

<form:label path="dateFin">Retour</form:label>
<form:input path="dateFin" /><br>

<form:label path="dateDemande">Date de demande</form:label>
<form:input path="dateDemande" /><br>
